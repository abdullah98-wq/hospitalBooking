          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                  @if(Auth::guard('doctor')->check())
                      <a class="dropdown-item text-color" href="{{ route('doctor.profile',Auth::guard('doctor')->user()->id)}}">
                          {{ __('view profile') }}
                      </a>
                  @else
                    <a class="dropdown-item text-color" href="{{ route('patient.profile',Auth::user()->id)}}">
                          {{ __('view profile') }}
                      </a>
